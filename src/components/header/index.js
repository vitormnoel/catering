...
// import {Marcellus as marcellus} from
...
function Header() {
  return (
    <header className="">
      ...
      <div className="mt-20 mx-24 text-center flex flex-col justify-center items-center gap-16 h-[95vh] static">
        ...
        <div className="font-header text-blue-logo">
          <h2 className="text-7xl capitalize">
            your trusted corporate caterer
          </h2>
          <h3 className="text-lg capitalize font-extralight text-slate-600">
            with kitchens in Vancouver & Surrey - serving Metro Vancouver and
            the Fraser Valley
          </h3>
        </div>

        {/* TO DO: images */}
        {/* <div className="flex gap-4 justify-center bottom-10 right-20">
          
          <ItemImage src={"/images/4.jpg"}/>
          <ItemImage src={"/images/6.jpg"}/>
        </div> 
        */}
      </div>
    </header>
